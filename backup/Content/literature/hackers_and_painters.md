- [《黑客与画家》笔记](#黑客与画家笔记)
	- [第一章节：为什么书呆子不受欢迎](#第一章节为什么书呆子不受欢迎)
	- [第二章节：黑客与画家](#第二章节黑客与画家)
	- [第三章节：不能说的话](#第三章节不能说的话)
	- [第四章节：良好的坏习惯](#第四章节良好的坏习惯)
	- [第五章节：另一条路](#第五章节另一条路)
	- [第六章节：如何创造财富](#第六章节如何创造财富)
	- [第七章节：关注贫富分化](#第七章节关注贫富分化)
	- [第八章节：防止垃圾邮件的一种方法](#第八章节防止垃圾邮件的一种方法)
	- [第九章节：设计者的品味](#第九章节设计者的品味)
	- [第十章：编程语言解析](#第十章编程语言解析)
	- [第十一章：一百年后的编程语言](#第十一章一百年后的编程语言)
	- [第十二章：拒绝平庸](#第十二章拒绝平庸)
	- [第十二章：书呆子的复仇](#第十二章书呆子的复仇)
	- [第十四章：梦寐以求的编程语言](#第十四章梦寐以求的编程语言)
	- [第十五章：设计与研究](#第十五章设计与研究)
# 《黑客与画家》笔记
...
机器语言和汇编语言的共同问题就是，只能让大多数计算机做一些很简单的事情。比如，假定你想让计算机的蜂鸣器响10次，但是不存在一条直接的机器语言命令让电脑重复进行n次操作，所以只能用机器语言写出下面这样的程序：
	...
	a  将数字10存入内存地址0如果内存地址0的值为负数，跳到b行蜂鸣器发出声音将内存地址0的值减1跳到a行b  ……程序的其他部分……
...
> 主要说创业公司应该选择一个能节省开发效率的语言，作者主要推崇了Lisp，Lisp问世不久，用的人还不多，作者决定使用Lisp原因，是因为它极高的开发效率，可以在很短时间内开发出与竞品一样的功能，是他的秘密武器。
...
1956年Fortran刚诞生的时候，叫做Fortran I，与今天的Fortran语言差别极大。Fortran I 实际上是汇编语言加上数学，在某些方面还不如今天的汇编语言强大。比如，它没有子例程，只有分支跳转结构（branch）。今天的Fortran语言可以说更接近Lisp而不是Fortran I。
