...
categories:
  - MySQL
date: 2019.04.04 19:56:08
updated: 2019.04.04 19:56:08
---
...
1.2.  唯一索引，与前面的普通索引类似，不同的就是：索引列的值必须唯一，但允许有空值。如果是组合索引，则列值的组合必须唯一。它有以下几种创建方式：
...
1.3 主键索引，是一种特殊的唯一索引，一个表只能有一个主键，不允许有空值。
...
##  2. MyISAM 和 InnoDB 索引实现

###  2.1. MyISAM 索引实现

MyISAM 引擎使用 B+Tree 作为索引结构，叶节点的 data 域存放的是数据记录的地址。下图是 MyISAM 索引的原理图：

![MyISAM1.png](https://upload-images.jianshu.io/upload_images/12321605-d1af7a310e711e1f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![MyISAM2.png](https://upload-images.jianshu.io/upload_images/12321605-7f0bb0cbdb8c317e.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![InnoDB1.png](https://upload-images.jianshu.io/upload_images/12321605-788ffd17399abb7b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![InnoDB2.png](https://upload-images.jianshu.io/upload_images/12321605-4a33c65b8bee4a05.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![mysql-index-clustered.jpg](https://upload-images.jianshu.io/upload_images/12321605-36a596bc5c6b7811.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

非聚集（unclustered）索引。

> 定义：该索引中索引的逻辑顺序与磁盘上行的物理存储顺序不同，一个表中可以拥有多个非聚集索引。

![mysql-index-unclustered.jpg](https://upload-images.jianshu.io/upload_images/12321605-f8f6eecbb36726cb.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


非聚集索引查询过程：

![mysql-index-unclustered2.jpg](https://upload-images.jianshu.io/upload_images/12321605-cfee18215d932101.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
