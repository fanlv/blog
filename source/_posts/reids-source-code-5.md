...
categories:
  - Redis
date: 2019.08.10 20:50:06
updated: 2019.08.10 20:50:06
---
...
![redis_zip_list.jpg](https://upload-images.jianshu.io/upload_images/12321605-63de3bf3d019f760.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![redis_zip_list2.png](https://upload-images.jianshu.io/upload_images/12321605-711c43158d719f10.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_zip_list_entity.jpg](https://upload-images.jianshu.io/upload_images/12321605-a36b1b5bd4f4ee33.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_zip_list_string_encode.jpg](https://upload-images.jianshu.io/upload_images/12321605-cf731e9e006ee635.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_zip_list_int_encode.jpg](https://upload-images.jianshu.io/upload_images/12321605-b771a4360ca5b3af.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


整数节点的`encoding`的长度为8位，其中高2位用来区分整数节点和字符串节点（**高2位为11时是整数节点**），低6位用来区分整数节点的类型。

值得注意的是 最后一种`encoding`是存储整数`0~12`的节点的`encoding`，它没有额外的`data`部分，`encoding`的高4位表示这个类型，低4位就是它的`data`。这种类型的节点的`encoding`大小介于`ZIP_INT_24B`与`ZIP_INT_8B`之间（`1~13`），但是为了表示整数0，取出低四位xxxx之后会将其-1作为实际的data值（`0~12`）。
...
![redis_zip_list_memory.png](https://upload-images.jianshu.io/upload_images/12321605-6c1c42e416aefd0b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
