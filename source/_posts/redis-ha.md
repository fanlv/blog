...
categories:
  - Redis
date: 2019.08.17 21:06:17
updated: 2019.08.17 21:06:17
---
...
![redis_ha.jpg](https://upload-images.jianshu.io/upload_images/12321605-d40150a311ac6baf.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_ha2.jpg](https://upload-images.jianshu.io/upload_images/12321605-e9183477493b1ea0.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

### 主从复制过程

一般当`slave`第一次启动连接`master`，或者“被认为是第一次连接”，是主从采用全量复制。全量复制的执行流程如下：

0. `slave redis`启动. 会从`redis.conf`中读取`master ip`和`host`。
1. 定时任务每秒检查是否有新的`mater`需要连接，如果发现就与`master`建立`socket`连接。
1. `slave`发送`ping`指令到`mater`。
1. 如果`mater`配置`require pass`，`slave`需要发送认证给`master`。
1. `Salve`会发送`sync`命令到`Master`。
1. `Master`启动一个后台进程，将`Redis`中的数据快照`rdb`保存到文件中。
1. 启动后台进程的同时，`Master`会将保存数据快照期间接收到的写命令缓存起来。
1. `Master`完成写文件操作后，将`rdb`发送给`Salve`。
1. `Salve`将`rdb`保存到磁盘上，然后加载`rdb`到`redis`内存中。
1. 当`Salve`完成数据快照的恢复后，`aster`将这期间收集的写命令发送给`Salve`端。
1. 后续`Master`收集到的写命令都会通过之前建立的连接. 增量发送给`salve`端。

调用流程图如下：

![redis_ha3.png](https://upload-images.jianshu.io/upload_images/12321605-015172e80a36cbf8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_ha5.png](https://upload-images.jianshu.io/upload_images/12321605-afa5a277af081522.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_ha6.png](https://upload-images.jianshu.io/upload_images/12321605-5e4cccf724c0171d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![sentinel1.jpg](https://upload-images.jianshu.io/upload_images/12321605-771ecf18a316edfa.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![sentinel2.jpg](https://upload-images.jianshu.io/upload_images/12321605-cc3816b327b408ef.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

2. 每个 `Sentinel` 节点通过定期监控发现主节点出现了故障
![sentinel3.jpg](https://upload-images.jianshu.io/upload_images/12321605-40e38f9e7962d445.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

3. 多个 `Sentinel` 节点对主节点的故障达成一致会选举出其中一个节点作为领导者负责故障转移。
![sentinel4.jpg](https://upload-images.jianshu.io/upload_images/12321605-0715f5b0582e6727.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

4. `Sentinel` 领导者节点执行了故障转移，整个过程基本是跟我们手动调整一致的，只不过是自动化完成的。
![sentinel5.jpg](https://upload-images.jianshu.io/upload_images/12321605-e3d93d05e45854fc.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

5. 故障转移后整个 `Redis Sentinel` 的结构,重新选举了新的主节点。
![sentinel6.jpg](https://upload-images.jianshu.io/upload_images/12321605-a897e6d46c2719d3.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_cluster1.png](https://upload-images.jianshu.io/upload_images/12321605-5c73401d2a284189.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_cluster2.png](https://upload-images.jianshu.io/upload_images/12321605-a94db6b07f492f8c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_cluster3.png](https://upload-images.jianshu.io/upload_images/12321605-95ffb2dd63839402.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_cluster4.png](https://upload-images.jianshu.io/upload_images/12321605-2b9fe948264b0e40.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_cluster5.png](https://upload-images.jianshu.io/upload_images/12321605-0a10c4294c3c4761.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_cluster6.png](https://upload-images.jianshu.io/upload_images/12321605-c41dbad3d2a4360c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_custome1.png](https://upload-images.jianshu.io/upload_images/12321605-b82013e6da242531.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_codis0.png](https://upload-images.jianshu.io/upload_images/12321605-7742a644c16a2db6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![codis1.jpg](https://upload-images.jianshu.io/upload_images/12321605-a778dd9930066ecf.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![codis2.jpg](https://upload-images.jianshu.io/upload_images/12321605-c2088ea1947ad811.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![codis3.jpg](https://upload-images.jianshu.io/upload_images/12321605-a0862d85c6170458.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![redis_twemproxy1.png](https://upload-images.jianshu.io/upload_images/12321605-b33bfe6e772aefb5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

基于 twemproxy 的高可用架构图

![redis_twemproxy2.png](https://upload-images.jianshu.io/upload_images/12321605-da2fbbbc086ebc77.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
[（一）redis 主从原理及流程——主从复制](https://blog.csdn.net/zb6340430/article/details/80914681)

[这可能是目前最全的 Redis 高可用技术解决方案总结](https://yq.aliyun.com/articles/626532)

[Redis 哨兵机制](https://segmentfault.com/a/1190000018278099?utm_source=tag-newest)

[redis 如何实现高可用【主从复制、哨兵机制】](https://blog.csdn.net/itcats_cn/article/details/82428716)

[理解 Redis 集群](https://blog.csdn.net/codejas/article/details/79854953)

[三张图秒懂 Redis 集群设计原理](https://blog.csdn.net/yejingtao703/article/details/78484151)
